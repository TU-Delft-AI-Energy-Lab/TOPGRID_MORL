    ...
    for file_path, _ in files_with_times:
        with open(file_path, "r") as json_file:
            ...
            eval_data_list["rewards"].append({
                "file_path": file_path,
                "eval_rewards": eval_data["eval_rewards"]
            })
...
def sum_rewards(rewards):
    ...
    # Sum along the desired axis (e.g., sum along the second axis)
...
dir_path = os.path.join("eval_logs", "rte_case5_example_val", "['ScaledTopoDepth', 'TopoAction']", "weights_1.00_0.00_0.00")
